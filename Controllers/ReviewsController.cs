...
namespace MVCBook.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ReviewsController(MVCBookContext context, UserManager<MVCBookUser> usermanager)
        {
            _context = context;
            _userManager = usermanager;
        }

        private Task<MVCBookUser> GetCurrentUserAsync() => _userManager.GetUserAsync(HttpContext.User);
        // GET: Reviews
        ...
        {
            MVCBookUser user=await GetCurrentUserAsync();
